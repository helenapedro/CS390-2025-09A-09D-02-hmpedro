...
public class MyClass {
   ...
   static private String ab = "Hello";
    ...
    // Outer class method
    public void omethod(int data){ // By default data is final inside local
        int loc = 56;
        loc = 200;
      class Local{
            Local(){
    ...
    public class MyInner{
        ...
        static private int k = 100;// From JDK 16, inner class can have static fields
        public MyInner(){
          //  System.out.println("Inner Class");
        }
        void display(){
            // Inner class can access outer/enclosing class methods and fields even private
    ...
    static public class MyStatic{
        ...
        static private int a1 = 20;
               ...
               public static void m1(){
                  ...
                  // System.out.println(a2); // Static method can access only static fields
