package week3.homework.after.prob2;

import W3L8_HW_Asgmt.after.prob2.EmployeeData;
import W3L8_HW_Asgmt.after.prob2.Staff;
import W3L8_HW_Asgmt.after.prob2.Statistics;
import W3L8_HW_Asgmt.after.prob2.Teacher;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Salary Sum: " + salarySum); // 1035500.0
    }

    //IMPLEMENT
    public static List<EmployeeData> combine(List<Staff> staff, List<Teacher> teachers) {
        List<EmployeeData> combined = new ArrayList<>(staff.size() + teachers.size());
        // Using addAll
        combined.addAll(staff);
        combined.addAll(teachers);
        return combined;

        // Using add and checking for null values
//        for (Staff st : staff) {
//            if (st != null) {
//                combined.add(st);
//            }
