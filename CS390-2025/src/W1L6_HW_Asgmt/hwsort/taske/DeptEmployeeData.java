package W1L6_HW_Asgmt.hwsort.taske;
...
public class DeptEmployeeData {
	public static void main(String[] args) {
		...
		//  Sort the DeptEmployee array using Lambda - hire date field by natural order.
		Arrays.sort(arr, (o1, o2) -> o2.getHireDate().compareTo(o1.getHireDate()));
